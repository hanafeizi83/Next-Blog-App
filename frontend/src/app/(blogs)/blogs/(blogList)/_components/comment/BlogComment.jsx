...
async function BlogComment({ blog }) {
    return (
        <>
            <div className="w-full lg:w-[75%]">
                ...
                <AddCommentForm blogId={blog?._id} blogSlug={blog?.slug} />
                                    ...
                                    {comment.answers && comment.answers.map((comment, index) => (
                                        <div key={comment._id} className="relative">
                                            <div className={classNames(
                                                ...
                                                <Comment key={comment._id} comment={comment} blogId={blog._id} blogSlug={blog?.slug} />
                                            </div>
                                        </div>
                                    ))}
                                </div>
