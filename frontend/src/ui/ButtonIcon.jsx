const btnType = {
    ...
    secondary: 'bg-secondary-200 text-secondary-800 hover:bg-secondary-800 hover:text-secondary-100',
...
function ButtonIcon({ variant, children, className, onClick, ...rest }) {
    return (
        <button
            onClick={onClick}
            className={`${btnType[variant]} ${className} rounded-full w-8 h-8 relative flex items-center justify-center 
